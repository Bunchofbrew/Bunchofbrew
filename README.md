...
>
> **Pᴇʀsᴏɴᴀʟʟʏ Iɴᴛᴇʀᴇsᴛᴇᴅ Iɴ ?**
> - [x] [`Mᴏɴᴛᴇ Cᴀʀʟᴏ ᴇxᴘᴇʀɪᴍᴇɴᴛs`](https://en.wikipedia.org/wiki/Monte_Carlo_method) modeling uncertainty
> - [x] [`Kᴏᴜ Jᴜᴍᴘ-Dɪғғᴜsɪᴏɴ Mᴏᴅᴇʟ`](https://www.columbia.edu/~sk75/MagSci02.pdf) Stock diffusion method
> - [x] [`Oᴘᴇɴ Sᴏᴜʀᴄᴇ Rɪsᴋ`](https://github.com/OpenSourceRisk/Engine) for pricing and risk analysis
